    ...
    <div class="wrapper">
                ...
                <div class="app-brand">
                    <a href="/index.html">
                        @if (Auth::user()->profile_pic)
                            <img style="width:70px;" src="/uploads/profile/{{ Auth::user()->profile_pic }}"
                                alt="auth-profile"
                                class="img-fluid auth-img rounded-circle border border-white bg-white transition-x" />
                        @else
                            <img style="width:70px;"
                                src="https://avatars.dicebear.com/api/initials/{{ Auth::user()->name . ' ' . Auth::user()->last_name }}.svg"
                                alt="auth-profile"
                                class="img-fluid auth-img rounded-circle border border-white bg-white transition-x" />
                        @endif
                                ...
                                <div class="sub-menu">
                                    ...
                                    <li>
                                        <a class="sidenav-item-link"
                                            href="{{ route('settings.profile', auth()->user()->id) }}">
        ...
        <footer class="footer mt-auto">
            <div class="copyright bg-white">
                <p>
                    &copy; <span id="copy-year"></span> Dashboard <a class="text-primary"
                        href="http://www.iamabdus.com/" target="_blank">Quarec Resource</a>.
                </p>
            </div>
            <script>
                var d = new Date();
